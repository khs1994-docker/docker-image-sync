...
# ARG CONFIG_URL=https://raw.githubusercontent.com/khs1994-docker/lnmp/20.10/dockerfile/sync/docker-image-sync-by-docker.json

COPY docker-image-sync-by-docker.json docker-image-sync.json
